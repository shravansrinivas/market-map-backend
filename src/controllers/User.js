...
module.exports = {
    create: async (req, res, next) => {
        ...
        const emailBody = `Hey ${name},<br/> Welcome to LE's Market Map! You can access the platform at ${process.env.SITE_URL} with the following credentials:<br/><strong>email: ${email}<br/>password: ${autoGeneratedPass}</strong/><br/> Thank you,<br/>The Market Map Team, LetsEndorse🧑🏽‍💻`;
        const subject = `Welcome to LetsEndorse Market Map :)`;
